...
alias backpack-rn-setup='backpack-rn && echo "v12.13.0" > .nvmrc && touch android/local.properties && npm i && cd ios/ && bundle exec pod repo update && bundle exec pod install --repo-update && backpack-rn && backpack-rn-copy-font-files'
