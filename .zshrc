...
alias gml=' if [[ $(pwd) == *"webapp-boilerplate"* ]]; then IMPLEMENTATION-git-main-latest; elif [[ $(pwd) == *"skyscanner-app"* ]]; then IMPLEMENTATION-git-develop-latest; else IMPLEMENTATION-git-master-latest; fi'
