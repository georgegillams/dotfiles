...
function git-make-mr() { touch remove.txt && git-add-all && git-commit-push -m $@ && rm remove.txt && git-add-all && git-commit-push "squash me" }
...
alias backpack-run-emulators='backpack && runios && backpack-run-android'
alias backpack-run-docs='backpack && npm run docs'
alias backpack-run-neo='backpack && npm run docs:neo'
