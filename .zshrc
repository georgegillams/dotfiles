...
alias IMPLEMENTATION-git-rebase-main='git-fetch && (git rebase origin/master | grep CONFLICT || true) && git-submodules-pull'
alias IMPLEMENTATION-git-rebase-develop='git-fetch && (git rebase origin/develop | grep CONFLICT || true) && git-submodules-pull'
alias grm=' if [[ $(pwd) == *"skyscanner-app"* ]]; then IMPLEMENTATION-git-rebase-develop; else IMPLEMENTATION-git-rebase-main; fi'
