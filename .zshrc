...
alias gml='if [[ $(pwd) == *"browser-scripts"* ]]; then IMPLEMENTATION-git-main-latest; elif [[ $(pwd) == *"dotfiles"* ]]; then IMPLEMENTATION-git-main-latest; elif [[ $(pwd) == *"webapp-boilerplate"* ]]; then IMPLEMENTATION-git-main-latest; elif [[ $(pwd) == *"skyscanner-app"* ]]; then IMPLEMENTATION-git-develop-latest; else IMPLEMENTATION-git-master-latest; fi'
...
alias grm='if [[ $(pwd) == *"browser-scripts"* ]]; then IMPLEMENTATION-git-rebase-main; elif [[ $(pwd) == *"dotfiles"* ]]; then IMPLEMENTATION-git-rebase-main; elif [[ $(pwd) == *"webapp-boilerplate"* ]]; then IMPLEMENTATION-git-rebase-main; elif [[ $(pwd) == *"skyscanner-app"* ]]; then IMPLEMENTATION-git-rebase-develop; else IMPLEMENTATION-git-rebase-master; fi'
