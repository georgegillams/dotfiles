...
alias IMPLEMENTATION-git-main-latest='gco main && git-fetch && git reset --hard origin/main && git pull && (git branch -D $(git-branch | grep -v "main") || true) && git submodule update && git-reset'
alias IMPLEMENTATION-git-master-latest='gco master && git-fetch && git reset --hard origin/master && git pull && (git branch -D $(git-branch | grep -v "master") || true) && git submodule update && git-reset'
...
alias gml='if [[ $(pwd) == *"gg-components"* ]]; then IMPLEMENTATION-git-main-latest; elif [[ $(pwd) == *"beta"* ]]; then IMPLEMENTATION-git-main-latest; elif [[ $(pwd) == *"browser-scripts"* ]]; then IMPLEMENTATION-git-main-latest; elif [[ $(pwd) == *"dotfiles"* ]]; then IMPLEMENTATION-git-main-latest; elif [[ $(pwd) == *"webapp-boilerplate"* ]]; then IMPLEMENTATION-git-main-latest; elif [[ $(pwd) == *"skyscanner-app"* ]]; then IMPLEMENTATION-git-develop-latest; else IMPLEMENTATION-git-master-latest; fi'
...
alias grm='if [[ $(pwd) == *"gg-components"* ]]; then IMPLEMENTATION-git-rebase-main; elif [[ $(pwd) == *"beta"* ]]; then IMPLEMENTATION-git-rebase-main; elif [[ $(pwd) == *"browser-scripts"* ]]; then IMPLEMENTATION-git-rebase-main; elif [[ $(pwd) == *"dotfiles"* ]]; then IMPLEMENTATION-git-rebase-main; elif [[ $(pwd) == *"webapp-boilerplate"* ]]; then IMPLEMENTATION-git-rebase-main; elif [[ $(pwd) == *"skyscanner-app"* ]]; then IMPLEMENTATION-git-rebase-develop; else IMPLEMENTATION-git-rebase-master; fi'
...
function git-revert-to-main() { if [[ $(pwd) == *"gg-components"* ]]; then IMPLEMENTATION-git-revert-to-main $@ ; elif [[ $(pwd) == *"beta"* ]]; then IMPLEMENTATION-git-revert-to-main $@ ; elif [[ $(pwd) == *"browser-scripts"* ]]; then IMPLEMENTATION-git-revert-to-main $@ ; elif [[ $(pwd) == *"dotfiles"* ]]; then IMPLEMENTATION-git-revert-to-main $@ ; elif [[ $(pwd) == *"webapp-boilerplate"* ]]; then IMPLEMENTATION-git-revert-to-main $@ ; elif [[ $(pwd) == *"skyscanner-app"* ]]; then IMPLEMENTATION-git-revert-to-develop $@ ; else IMPLEMENTATION-git-revert-to-master $@ ; fi }
...
alias bis='bi && bi-bump-ruby-version && rvm use && bundle install && nvm use && npm ci && (cd Example && bundle install && bundle exec pod update) && npx gulp'
