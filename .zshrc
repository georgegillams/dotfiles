...
alias backpack-setup='backpack && npm i && npm run build && git submodule update'
...
alias backpack-react-native-setup='backpack-react-native && touch android/local.properties && npm i && npm run build && cd ios/ && bundle install && bundle exec pod install && backpack-react-native'
