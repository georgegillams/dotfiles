...
alias bts='bt && npm ci'
alias bt-ship='bt && gclean && bts && npm run pull-backpack && npm run release'
...
alias bi-release='bi && BUILD_SDK=iphonesimulator13.5 DESTINATION="platform=iOS Simulator,name=iPhone 8" bundle exec rake release'
alias bi-publish='bi-release'
alias bi-build-ipa='bi && sh ~/Dropbox/secrets/backpack-ios/backpack-build-ipa && git-reset'
alias bi-test='bi && BUILD_SDK=iphonesimulator13.5 DESTINATION="platform=iOS Simulator,name=iPhone 8" bundle exec rake test && Example/Pods/SwiftLint/swiftlint lint --strict'
