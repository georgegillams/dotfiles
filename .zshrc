...
alias gml=' if [[ $(pwd) == *"webapp-boilerplate"* ]]; then IMPLEMENTATION-git-develop-main; elif [[ $(pwd) == *"skyscanner-app"* ]]; then IMPLEMENTATION-git-develop-latest; else IMPLEMENTATION-git-master-latest; fi'
...
alias grm='if [[ $(pwd) == *"webapp-boilerplate"* ]]; then IMPLEMENTATION-git-rebase-main; elif [[ $(pwd) == *"skyscanner-app"* ]]; then IMPLEMENTATION-git-rebase-develop; else IMPLEMENTATION-git-rebase-master; fi'
