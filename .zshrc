...
alias git-push-force-with-verification='ggf'
alias git-push-force='ggf --no-verify'
...
alias backpack-setup='backpack && npm i && npm run build && npm run bootstrap && npm run build && git submodule update'
...
alias backpack-react-native-setup='backpack-react-native && touch android/local.properties && npm i && npm run build && npm run bootstrap && npm run build && cd ios/ && bundle install && bundle exec pod install && backpack-react-native'
...
alias backpack-react-native-run-native='backpack-react-native && npm run native'
alias backpack-react-native-run-android='backpack-react-native && ($ANDROID_SDK_ROOT/emulator/emulator -avd PIXEL_2_XL_API_27 || true) & (cd native && npm run android:build)'
alias backpack-react-native-run-android-old='backpack-react-native && ($ANDROID_SDK_ROOT/emulator/emulator -avd NEXUS_4_API_24 || true) & (cd native && npm run android:build)'
alias backpack-react-native-run-android-docs='backpack-react-native && ($ANDROID_SDK_ROOT/emulator/emulator -avd NEXUS_5_API_27 || true) & (cd native && npm run android:build)'
alias backpack-react-native-run-ios='backpack-react-native && (cd native && react-native run-ios --simulator="iPhone XS")'
alias backpack-react-native-run-ios-docs='backpack-react-native && (cd native && react-native run-ios --simulator="iPhone 8")'
alias backpack-react-native-run-docs='backpack-react-native && npm run docs'
