...
alias bi-release='bi && git-revert-to-main .ruby-version && BUILD_SDK=iphonesimulator13.5 DESTINATION="platform=iOS Simulator,name=iPhone 8" bundle exec rake release'
alias bi-publish='bi-release'
alias bi-build-ipa='bi && sh ~/Dropbox/secrets/backpack-ios/backpack-build-ipa && git-reset'
alias bi-test='bi && BUILD_SDK=iphonesimulator13.3 DESTINATION="platform=iOS Simulator,name=iPhone 8" bundle exec rake test && Example/Pods/SwiftLint/swiftlint lint --strict'
