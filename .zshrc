...
alias backpack-react-native-setup='backpack-react-native && touch android/local.properties && npm i && npm run bootstrap && cd ios/ && bundle install && bundle exec pod install && backpack-react-native'
