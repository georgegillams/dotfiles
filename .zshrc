...
alias improve-vpn-connection='cd ~/Documents/lazarlazarov/local-vpn-routing && git-reset && git-master-latest && sudo ./tunnel_vpn.py'
...
alias backpack-ios-release='backpack-ios && BUILD_SDK=iphonesimulator13.3 DESTINATION="platform=iOS Simulator,name=iPhone 8" bundle exec rake release'
