...
alias backpack-rn-setup='backpack-rn && touch android/local.properties && npm i && cd ios/ && bundle install && bundle exec pod install && backpack-rn'
...
alias backpack-rn-run-ios='backpack-rn && r-n run-ios --simulator="iPhone XS"'
alias backpack-rn-run-ios-docs='backpack-rn && r-n run-ios --simulator="iPhone 8"'
