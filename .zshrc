...
alias dotfiles-save-vscode-settings='dotfiles && cp ~/Library/Application\ Support/Code/User/*.json ./vscode/ && git-add-all && git-commit-push "Update vscode settings"'
...
alias backpack-ios-swiftlint='(cd Example && Pods/SwiftLint/swiftlint lint --strict --config .swiftlint.yml)'
alias backpack-ios-lint='backpack-ios && rake lint && backpack-ios-swiftlint'
...
alias backpack-ios-take-screenshots-basic='backpack-ios && rake take_screenshots'
