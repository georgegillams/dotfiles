...
alias backpack-undeploy-neo-docs-test='cd ~/Documents && echo `<h1 style="display: flex;text-align: center;flex-direction: row;justify-content: space-around;line-height: 15rem;font-size: 3rem;">Coming soon...</h1>` > index.html'
