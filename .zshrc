...
alias backpack-rn-setup='backpack-rn && touch android/local.properties && npm i && cd ios/ && bundle install && pod update react-native-bpk-component-calendar && bundle exec pod install --repo-update && backpack-rn'
...
alias backpack-ios-test='backpack-ios && BUILD_SDK=iphonesimulator12.1 DESTINATION="platform=iOS Simulator,name=iPhone 8" bundle exec rake test && Example/Pods/SwiftLint/swiftlint lint --strict'
...
alias skyscanner-ios-app-setup='skyscanner-ios-app && sudo gem install bundler && (cd ios && rvm use 2.3.1 && ./fullsetup) && skyscanner-ios-app'
