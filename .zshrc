...
alias personal-zoom='open $(cat ~/Dropbox/secrets/personalzoomrc)'
alias backpack-zoom='open $(cat ~/Dropbox/secrets/backpackzoomrc)'
...
alias backpack-rn-run-ios='backpack-rn && react-native run-ios --simulator="iPhone 11"'
...
alias backpack-ios-setup='backpack-ios && bundle install && nvm use 8.12.0 && npm ci && (cd Example && bundle exec pod update) && npx gulp'
...
alias backpack-ios-release='backpack-ios && BUILD_SDK=iphonesimulator13.0 DESTINATION="platform=iOS Simulator,name=iPhone 8" bundle exec rake release'
alias backpack-ios-publish='backpack-ios-release'
alias backpack-ios-build-ipa='backpack-ios && sh ~/Dropbox/secrets/backpack-build-ipa && git-reset'
...
alias skyscanner-app-setup='skyscanner-app && gem install bundler && (cd ios && rvm use 2.6.3 && ./fullsetup && bundle exec pod update) && skyscanner-app'
