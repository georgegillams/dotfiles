...
alias backpack-setup='backpack && touch native/android/local.properties && npm install && npm run build && npm run bootstrap && npm run build'
...
alias backpack-run-docs='backpack && npm run docs:neo'
alias backpack-run-docs-neo='backpack && npm run docs:neo'
alias backpack-compile-docs='backpack && npm install && npm run build && npm run docs:neo:dist'
