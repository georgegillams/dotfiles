...
alias create-bpk-dep-pr='gco -b NO-JIRA-update-bpk-dependencies && git-add-all && git-commit-push "Update bpk dependencies" && open https://github.com/Skyscanner/backpack-ios/pull/new/NO-JIRA-update-bpk-dependencies'
