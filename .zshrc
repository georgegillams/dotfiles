...
alias backpack-output-all-outdated='backpack-check-outdated-npm-packages > ~/Desktop/outdated.txt && backpack-check-outdated-npm-packages-native >> ~/Desktop/outdated_native.txt'
