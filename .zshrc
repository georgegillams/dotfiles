...
alias backpack-undeploy-neo-docs='backpack-neo-gh-pages && find . -and -not -path "./.git*" -delete && echo "<h1>Coming soon...</h1>" > index.html && git-add-all && git-commit-push "undeploy"'
