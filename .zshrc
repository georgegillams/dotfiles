...
alias git-rebase-master='git-fetch && git rebase origin/master | grep CONFLICT && git-submodules-pull'
alias git-rebase-develop='git-fetch && git rebase origin/develop | grep CONFLICT && git-submodules-pull'
