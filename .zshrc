...
alias backpack-rn-setup='backpack-rn && touch android/local.properties && npm i && cd ios/ && bundle install && bundle exec pod install --repo-update && pod update react-native-bpk-component-calendar && backpack-rn'
