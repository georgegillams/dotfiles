...
alias gml='if [[ $(pwd) == *"gitlab"* ]]; then IMPLEMENTATION-git-develop-latest; elif [[ $(pwd) == *"Documents/Typeform/terraform-shared"* ]]; then IMPLEMENTATION-git-master-latest; elif [[ $(pwd) == *"Documents/Typeform/k8s-manifests"* ]]; then IMPLEMENTATION-git-master-latest; else IMPLEMENTATION-git-main-latest; fi'
...
alias grm='if [[ $(pwd) == *"gitlab"* ]]; then IMPLEMENTATION-git-rebase-develop; elif [[ $(pwd) == *"Documents/Typeform/terraform-shared"* ]]; then IMPLEMENTATION-git-rebase-master; elif [[ $(pwd) == *"Documents/Typeform/k8s-manifests"* ]]; then IMPLEMENTATION-git-rebase-master; else IMPLEMENTATION-git-rebase-main; fi'
alias gri='HUSKY=0 git rebase -i'
